...
&emsp;&emsp;O diagrama de pacotes fronted (imagem 2) representa a estrutura de diretórios que será utilizada no desenvolvimento da aplicação React. Os
...
<p align="justify"> &emsp;&emsp;O diagrama de pacotes do backend (imagem 3) representa a API que será desenvolvida com Django e Django REST Framework. O projeto principal se chama QuemFazNiverGostaDe e é dividido em duas pastas principais: apps e config.</p>
